...
const { sanitizeBody } = require('../../../validators/bodyValidator');
...
const { findAvailableFlights } = require('../services/passengerService');
const { createTransaction } = require('../services/transactionService');
const { createPassenger } = require('../services/passengerService');
const { updateTransactionHistory } = require('../services/transactionHistoryService');
